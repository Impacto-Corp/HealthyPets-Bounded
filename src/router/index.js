...
const PetRegisterComponent = () => import('../healthypets/registers/components/pet-register.component.vue');
const PetProfileComponent = () => import('../profiles/components/pet-profile.component.vue');
